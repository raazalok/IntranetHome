	...
	jQuery.fn[name] = function(options) {
		...
		if (tickerData.controls || tickerData.ownControls) {
			if (!tickerData.ownControls) {
			    $('<div id="ticker-controls"><span class="play"><a href="#play"><img src="/SiteCollectionImages/refresh/news-resume.gif" alt="Play" title="Play" /></a></span><span class="previous"><a href="#previous" title="Previous"><img src="/SiteCollectionImages/refresh/news-prev.gif" alt="Previous" title="Previous" /></a></span><span class="stop"><a href="#stop" title="Pause"><img src="/SiteCollectionImages/refresh/news-pause.gif" alt="Pause" title="Pause" /></a></span><span class="resume"><a href="#resume" title="Play"><img src="/SiteCollectionImages/refresh/news-resume.gif" alt="Play" title="Play" /></a></span><span class="next"><a href="#next" title="Next"><img src="/SiteCollectionImages/refresh/news-next.gif" alt="Next" title="Next" /></a></span></div>').insertAfter($(tickerData.newsList));
			}
			$('.play').hide();
		    $('.resume').hide();
